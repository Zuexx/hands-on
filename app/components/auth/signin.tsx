...
import signIn from "~/styles/components/auth.signin.css"
...
export function SignIn() {
    ...
    filterData =
        (signIn.data as AuthError)?.errorFields?.find((error) => error["email"] !== undefined);
    errEmail = filterData?.email;

    filterData =
        (signIn.data as AuthError)?.errorFields?.find((error) => error["password"] !== undefined);
            ...
            <section>
                ...
                <div className="signin">
                    <div className="content">
                        <h2>Sign In</h2>
                        <signIn.Form ref={ref} method='post' action="/login" className='form' noValidate>
